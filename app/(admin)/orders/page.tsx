...
const STATUS_OPTIONS = ['placed', 'confirmed', 'preparing', 'driver_assigned', 'out_for_delivery', 'delivered']
            ...
            <tbody className="divide-y divide-zinc-50">
              {filtered.map(order => (
                ...
                >
                  <td className="px-6 py-4">
                    <div className="flex items-center gap-3">
                      <div className="w-8 h-8 rounded-lg bg-[#1A0A00] flex items-center justify-center flex-shrink-0">
                        <ShoppingBag size={13} className="text-[#C8880A]" />
                      </div>
                  ...
                  <td className="px-6 py-4">
                    <p className="text-sm text-zinc-700 max-w-[160px] truncate">{order.restaurantName || '—'}</p>
                  </td>
                  <td className="px-6 py-4">
