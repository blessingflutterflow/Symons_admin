/**
 * Symon's Kitchen Admin Seed Script
 ...
 *
 * Example:
 *   node scripts/seed-admin.js admin@symonskitchen.co.za Admin@12345
 *
 * Requirements:
...
const API_KEY = 'AIzaSyCXdiIyqUwnQWhjIJBhHR_J0RDJksgcQFQ'
const PROJECT_ID = 'symonskitechen'
...
if (!email || !password) {
  ...
  console.error('Example: node scripts/seed-admin.js admin@symonskitchen.co.za Admin@12345')
  process.exit(1)
}
...
async function main() {
  ...
  if (status === 200) {
    ...
    console.log('\nYou can now sign in at the Symon\'s Kitchen Admin dashboard.')
  } else {
